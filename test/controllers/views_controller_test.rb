...
class ViewsControllerTest < ActionController::TestCase
  ...
  test "should create view" do
    assert_difference('View.count') do
      post :create, view: { ip_address: @view.ip_address, viewable_id: @view.viewable_id, viewable_type: @view.viewable_type }
    end
  ...
  test "should update view" do
    patch :update, id: @view, view: { ip_address: @view.ip_address, viewable_id: @view.viewable_id, viewable_type: @view.viewable_type }
    assert_redirected_to view_path(assigns(:view))
  end
